...
from src.util.utils import unique
...
class BB(object):
    ...
    def get_succ_addrs_full(self, valid_jump_targets):
        from src.slicing import slice_to_program, backward_slice
        from src.evm.exceptions import ExternalData
        from src.memory import UninitializedRead
        from src.evm.evm import run
        new_succ_addrs = set()
