from src.cfg.instruction import Instruction
from src.cfg.opcodes import potentially_user_controlled
from src.explorer.backward import traverse_back
from src.util.intrange import Range
